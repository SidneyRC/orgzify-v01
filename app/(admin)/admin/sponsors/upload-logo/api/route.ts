// THIS FILE GOES IN: app\(admin)\admin\sponsors\upload-logo\api\route.ts (REPLACES existing file)
...
export async function POST(req: NextRequest) {
  try {
    ...
    if (uploadError) {
      console.error('SPONSOR LOGO UPLOAD - storage error:', uploadError)
    ...
    console.error('SPONSOR LOGO UPLOAD - caught exception:', err?.name, err?.message, err?.stack)
